...
class SpectrumPropertiesWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        self.marker_combo.addItems([
            "None", "Circle (o)", "Square (s)", "Triangle (t)", 
    ...
    def set_spectrum(self, spectrum_id: Optional[str], spectrum_info: Optional[Dict[str, Any]]):
        ...
        if spectrum_id and spectrum_info:
            ...
            self.title_label.setText(f"Properties: {spectrum_info.get('label', spectrum_id)}")
    ...
    def _update_controls(self, spectrum_info: Dict[str, Any]):
        ...
        marker_map = {
            None: "None", 'o': "Circle (o)", 's': "Square (s)", 
            't': "Triangle (t)", 'd': "Diamond (d)", '+': "Plus (+)", 
            'x': "Cross (x)", '*': "Star (*)"
        }
    ...
    def _apply_changes(self):
        ...
        marker_map = {
            "None": None, "Circle (o)": 'o', "Square (s)": 's',
            "Triangle (t)": 't', "Diamond (d)": 'd', "Plus (+)": '+',
            "Cross (x)": 'x', "Star (*)": '*'
        }
...
class SpectralPropertiesPanel(QWidget):
    ...
    def _on_property_changed(self, spectrum_id: str, property_name: str, value):
        ...
        if property_name == 'remove':
            ...
            self.plot_widget.update_spectrum_properties(spectrum_id, **{property_name: value})
