...
class DualImageToolManager(QObject):
    ...
    click_handled = pyqtSignal(str, int, int, int, str)  # tool_name, image_index, x, y, view_type
    ...
    def set_image_indices(self, primary_index: int, secondary_index: int):
        ...
        logger.debug(f"Updated tool manager image indices: {primary_index}, {secondary_index}")
