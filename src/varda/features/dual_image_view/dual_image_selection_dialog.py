...
from PyQt6.QtWidgets import (
    ...
    QCheckBox, QSpinBox, QSlider, QFormLayout, QDialogButtonBox
)
...
class DualImageSelectionDialog(QDialog):
    ...
    def _create_link_type_group(self) -> QGroupBox:
        ...
        pixel_radio.setToolTip("Link images pixel-to-pixel (assumes same geographic extent)")
    ...
    def set_default_images(self, primary_index: Optional[int] = None, 
