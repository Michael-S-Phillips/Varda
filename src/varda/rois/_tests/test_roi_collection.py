...
class TestROICollectionCRUD:
    ...
    def test_add_multiple(
        ...
        fid1 = collection.addROI(sample_polygon, "A", (255, 0, 0, 128), ROIMode.RECTANGLE)
        fid2 = collection.addROI(sample_polygon, "B", (0, 255, 0, 128), ROIMode.POLYGON)
        assert fid1 != fid2
    ...
    def test_get_roi(
        ...
        fid = collection.addROI(sample_polygon, "ROI 1", (255, 0, 0, 128), ROIMode.RECTANGLE)
        roi = collection.getROI(fid)
        assert isinstance(roi, VardaROI)
        assert roi.name == "ROI 1"
        assert roi.color == (255, 0, 0, 128)
    ...
    def test_get_all_rois(
        ...
        collection.addROI(sample_polygon, "A", (255, 0, 0, 128), ROIMode.RECTANGLE)
        collection.addROI(sample_polygon, "B", (0, 255, 0, 128), ROIMode.POLYGON)
...
class TestROICollectionSignals:
    ...
    def test_collection_changed_signal(
        ...
        collection.addROI(sample_polygon, "ROI 1", (255, 0, 0, 128), ROIMode.RECTANGLE)
        collection.addROI(sample_polygon, "ROI 2", (0, 255, 0, 128), ROIMode.POLYGON)
        assert count[0] == 2
...
class TestROICollectionFids:
    def test_fids_property(
        ...
        f1 = collection.addROI(sample_polygon, "A", (255, 0, 0, 128), ROIMode.RECTANGLE)
        f2 = collection.addROI(sample_polygon, "B", (0, 255, 0, 128), ROIMode.POLYGON)
...
class TestPixelCoordinates:
    def test_pixel_space_returns_coords(self, collection: ROICollection) -> None:
        ...
        fid = collection.addROI(poly, "test", (255, 0, 0, 128), ROIMode.POLYGON)
...
class TestMask:
    def test_mask_shape_and_content(self, collection: ROICollection) -> None:
        ...
        fid = collection.addROI(poly, "box", (255, 0, 0, 128), ROIMode.RECTANGLE)
...
class TestSpectralStatistics:
    def test_mean_spectrum(self, collection: ROICollection) -> None:
        poly = box(2, 2, 8, 8)
        fid = collection.addROI(poly, "roi", (255, 0, 0, 128), ROIMode.RECTANGLE)
...
class TestFileIO:
    def test_geojson_round_trip(self, collection: ROICollection, tmp_path) -> None:
        ...
        collection.addROI(poly1, "ROI A", (255, 0, 0, 128), ROIMode.RECTANGLE)
        collection.addROI(poly2, "ROI B", (0, 255, 0, 200), ROIMode.POLYGON)
...
class TestApplyToImage:
    def test_apply_same_crs(self) -> None:
        ...
        source.addROI(poly, "A", (255, 0, 0, 128), ROIMode.RECTANGLE)
    ...
    def test_apply_no_crs_raises(self, collection: ROICollection) -> None:
        poly = box(0, 0, 10, 10)
        collection.addROI(poly, "A", (255, 0, 0, 128), ROIMode.RECTANGLE)
