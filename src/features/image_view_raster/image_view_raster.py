...
def createDualModeRasterView(proj, image_index, parent=None, is_overlay_secondary=False):
    """
    ...
    try:
        ...
        logger.error(f"Failed to create dual mode raster view for image {image_index}: {e}")
        return None
