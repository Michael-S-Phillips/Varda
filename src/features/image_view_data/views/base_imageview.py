...
from core.entities import Band, Stretch
...
class BaseImageView(QWidget):
    ...
    def __init__(self, viewmodel=None, parent=None):
        ...
        Args:
            viewmodel (ImageViewModel): The image viewmodels to associate with this
            view.
    ...
    def __populateBandComboBox(self):
        ...
        for band in self._viewmodel.getAllBands():
            self.__bandComboBox.addItem(band.name)
        self.__bandComboBox.setCurrentIndex(self._viewmodel.getBandIndex())
        self.__bandComboBox.currentIndexChanged.connect(self._viewmodel.setBandIndex)
        self.__viewControls.addWidget(self.__bandComboBox)
    ...
    def __populateStretchComboBox(self):
        ...
        for stretch in self._viewmodel.getAllStretches():
            self.__stretchComboBox.addItem(stretch.name)
        self.__stretchComboBox.setCurrentIndex(self._viewmodel.getStretchIndex())
        self.__stretchComboBox.currentIndexChanged.connect(
            self._viewmodel.setStretchIndex
        )
        self.__viewControls.addWidget(self.__stretchComboBox)
    ...
    def setViewmodel(self, viewmodel):
        ...
        Args:
            viewmodel (ImageViewModel): The image model to associate with this view.
        """
    ...
    def _linkSignals(self):
        ...
        """
        self._viewmodel.sigImageChanged.connect(self.onImageChanged)
        self._viewmodel.sigBandChanged.connect(self.onBandChanged)
        self._viewmodel.sigStretchChanged.connect(self.onStretchChanged)
    ...
    def getBand(self) -> Band:
        ...
        """
        return self._viewmodel.getCurrentBand()

    def getStretch(self) -> Stretch:
        """
        Returns the currently selected stretch from the selection model.
        ...
        """
        return self._viewmodel.getCurrentStretch()
    ...
    def setBandValues(self, r, g, b):
        ...
        """
        self._viewmodel.setBandValues(r, g, b)
    ...
    def setStretchValues(self, minR, maxR, minG, maxG, minB, maxB):
        ...
        """
        self._viewmodel.setStretchValues(minR, maxR, minG, maxG, minB, maxB)
    ...
    def getRasterData(self):
        ...
        """
        return self._viewmodel.getRasterData()
    ...
    def getRasterDataSlice(self):
        ...
        """
        return self._viewmodel.getRasterDataSlice()
    ...
    def getMetadata(self):
        ...
        """
        return self._viewmodel.getMetadata()
